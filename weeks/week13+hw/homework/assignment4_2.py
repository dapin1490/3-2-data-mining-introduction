...
res = open(r"weeks\week13+hw\homework\result_2.txt", 'w')  # vscode
# res = open(r"result_2.txt", 'w')  # pycharm
...
res.write(f"KNN accuracy : {knn_acc :.4f}\n")
res.write(f"Logistic Regression accuracy : {logic_reg_acc :.4f}\n")
res.write(f"Neural Network accuracy : {neu_net_acc :.4f}\n\n")
